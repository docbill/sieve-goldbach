...
in a previous paper in this series \cite{Riemers2026-GPCH} as a geometric framework for organizing remainder
...
\(2n = 23\#\), has been presented in a supportive paper in this series \cite{Riemers2025-PaperB}.
...
geometric framework developed in \cite{Riemers2026-GPCH}.
...
the first two papers of this series \cite{Riemers2025,Riemers2026-GPCH}.
...
\noindent
The following identities from \cite{Riemers2026-GPCH} hold,
\begin{align}
\label{ident:ssem}
...
\cite{Riemers2026-GPCH}, is restated here using the \(\ecap{\cdot}\) operator.
...
Bounding Envelope section of \cite{Riemers2026-GPCH}.
...
\emph{Monotonic Envelope Lemma} of \cite{Riemers2026-GPCH}, and
...
\end{equation}
By the \emph{Monotonic Envelope Lemma} of \cite{Riemers2026-GPCH},
...
\cite{Riemers2025-PaperB} provides strong empirical support for the framework.
