...
Related phenomena appear in large--scale optimization methods~\cite{bottou2018optimization,bottou2012stochastic},
where local updates propagate globally only after crossing scale--dependent
thresholds.  

A distinct but structurally analogous pattern appears in multiscale document
representation systems, where the introduction of additional representational
layers reorganizes global structure while preserving consistency across
scales, as in the multilayer raster formats developed by Bottou, Haffner,
and LeCun~\cite{bottou-01}.
