...
\begin{figure}[h]
  \centering
  \FigLambdaAbsSignSplit{lambdaboundmin-23PR.5-1-v0.2.0.csv}{n_0}{Lambda_min}{\( n_0 \)}{\( \lvert \Lambda_{\min}^{\text{bound}} \rvert \)}{\( |\Lambda_{\min}^{\text{bound}}| \) vs \( n_0 \) }
...
\begin{figure}[h]
  \centering
  \FigLambdaAbsSignSplit{lambdaboundmin-23PR.5-0.5-v0.2.0.csv}{n_0}{Lambda_min}{\( n_0 \)}{\( \lvert \Lambda_{\min}^{\text{bound}} \rvert \)}{\( |\Lambda_{\min}^{\text{bound}}| \) vs \( n_0 \) }
...
\begin{figure}[h]
  \centering
  \FigLambdaAbsSignSplit{lambdaboundmax-23PR.5-1-v0.2.0.csv}{n_1}{Lambda_max}{\( n_1 \)}{\( \lvert \Lambda_{\max}^{\tbound} \rvert \)}{\( |\Lambda_{\max}^{\tbound}| \) vs \( n_1 \) }
  \caption{Scatter plot of \( \lvert \Lambda_{\max}^{\tbound} \rvert \) versus \( n_1 \) for \( \alpha=1 \) on a log-log scale.}
  \label{fig:lambda-maxboundprim1}
\end{figure}
...
\begin{figure}[h]
  \centering
  \FigLambdaAbsSignSplit{lambdaboundmax-23PR.5-0.5-v0.2.0.csv}{n_1}{Lambda_max}{\( n_1 \)}{\( \lvert \Lambda_{\max}^{\tbound} \rvert \)}{\( |\Lambda_{\max}^{\tbound}| \) vs \( n_1 \) }
  \caption{Scatter plot of \( \lvert \Lambda_{\max}^{\tbound} \rvert \) versus \( n_1 \) for \( \alpha=0.5 \) on a log-log scale.}
  \label{fig:lambda-maxboundprim}
\end{figure}
