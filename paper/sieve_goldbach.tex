...
\section*{Corollary (conditional; short–interval equidistribution).}
...
\begin{equation}\tag{SI–BV$_\theta$}\label{eq:SIBV}
\sum_{q\le x^{\theta}}
...
The author gratefully acknowledges the work of Helfgott, whose proof of the Ternary Goldbach Conjecture illustrates the power of deep analytic methods and motivates pursuing complementary, sieve–centric approaches that minimize unstable terms while retaining rigorous bounds.
\end{remark}
